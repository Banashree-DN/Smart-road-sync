...
df = pd.read_csv(r"data_new.csv", skiprows=1, names=["right", "down", "left", "up", "total_passed", "avg_wt_time"])
...
def setTime():
    ...
    if direction=="right":
        ...
        last_data[3]=totalVehiclesLane4=up_model.predict(np.array([itern]).reshape(-1,1))[0][0]-last_data[3]
